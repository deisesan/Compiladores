...
public interface ParserConstants {
  ...
  int IDENTIFIER = 180;
  /** RegularExpression Id. */
  int NUMBER_INTEGER = 181;
  /** RegularExpression Id. */
  int NUMBER_FLOAT = 182;
  /** RegularExpression Id. */
  int SCALE_FACTOR = 183;
  /** RegularExpression Id. */
  int HEX_DIGIT_SEQUENCE = 184;
  /** RegularExpression Id. */
  int OCTAL_DIGIT_SEQUENCE = 185;
  /** RegularExpression Id. */
  int BIN_DIGIT_SEQUENCE = 186;
  /** RegularExpression Id. */
  int DIGIT_SEQUENCE = 187;
  /** RegularExpression Id. */
  int SIGNAL = 188;
  /** RegularExpression Id. */
  int CHARACTER_STRING = 189;
  /** RegularExpression Id. */
  int QUOTED_STRING = 190;
  /** RegularExpression Id. */
  int CONTROL_STRING = 191;
